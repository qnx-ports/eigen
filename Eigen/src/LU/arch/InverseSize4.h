...
struct compute_inverse_size4<Architecture::Target, float, MatrixType, ResultType>
{
  ...
  typedef conditional_t<(MatrixType::Flags & LinearAccessBit), MatrixType const &, typename MatrixType::PlainObject> ActualMatrixType;
...
struct compute_inverse_size4<Architecture::Target, double, MatrixType, ResultType>
{
  ...
  typedef conditional_t<(MatrixType::Flags & LinearAccessBit),
                         MatrixType const &,
