...
/** \ingroup SVD_Module
  ...
  * #ComputeThinV, #ComputeFullU, #ComputeFullV. It is not possible to request both the thin and full versions of a unitary. 
  * By default, unitaries will not be computed.
  *
...
JacobiSVD<MatrixType, Options>::compute_impl(const MatrixType& matrix, unsigned int computationOptions)
{
  using std::abs;
