...
template<typename MatrixType, typename Options, int QRPreconditioner, int Case,
...
template<typename MatrixType_, typename Options>
...
/** \ingroup SVD_Module
  ...
  */
template<typename MatrixType_, typename Options> class JacobiSVD
 : public SVDBase<JacobiSVD<MatrixType_,Options> >
{
  ...
  public:
    ...
    enum {
      QRPreconditioner = Options::preconditioner(),
      RowsAtCompileTime = MatrixType::RowsAtCompileTime,
      ColsAtCompileTime = MatrixType::ColsAtCompileTime,
...
*/
    template<typename MatrixType__, typename Options_, bool IsComplex_>
    friend struct internal::svd_precondition_2x2_block_to_be_real;
    template<typename MatrixType__, typename Options_, int QRPreconditioner_, int Case_, bool DoAnything_>
...
JacobiSVD<typename MatrixBase<Derived>::PlainObject, internal::DecompositionOptionsTag<Options>>
MatrixBase<Derived>::jacobiSvd(internal::DecompositionOptionsTag<Options>) const
{
