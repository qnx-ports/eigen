...
Packet8f prsqrt<Packet8f>(const Packet8f& _x) {
  EIGEN_DECLARE_CONST_Packet8f_FROM_INT_(inf, 0x7f800000);
  EIGEN_DECLARE_CONST_Packet8f_(one_point_five, 1.5f);
  EIGEN_DECLARE_CONST_Packet8f_(minus_half, -0.5f);
  EIGEN_DECLARE_CONST_Packet8f_FROM_INT_(flt_min, 0x00800000);
...
template <> EIGEN_DEFINE_FUNCTION_ALLOWING_MULTIPLE_DEFINITIONS EIGEN_UNUSED
Packet8f prsqrt<Packet8f>(const Packet8f& _x) {
  EIGEN_DECLARE_CONST_Packet8f_(one, 1.0f);
...
Packet4d prsqrt<Packet4d>(const Packet4d& _x) {
  EIGEN_DECLARE_CONST_Packet4d_(one, 1.0);
