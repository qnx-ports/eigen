...
Packet4f prsqrt<Packet4f>(const Packet4f& _x) {
  EIGEN_DECLARE_CONST_Packet4f_(one_point_five, 1.5f);
  EIGEN_DECLARE_CONST_Packet4f_(minus_half, -0.5f);
  EIGEN_DECLARE_CONST_Packet4f_FROM_INT_(inf, 0x7f800000u);
  EIGEN_DECLARE_CONST_Packet4f_FROM_INT_(flt_min, 0x00800000u);
