...
#define EIGEN_DECLARE_CONST_Packet16f_(NAME, X) \
  const Packet16f p16f_##NAME = pset1<Packet16f>(X)

#define EIGEN_DECLARE_CONST_Packet16f_FROM_INT_(NAME, X) \
  const Packet16f p16f_##NAME =  preinterpret<Packet16f,Packet16i>(pset1<Packet16i>(X))

#define EIGEN_DECLARE_CONST_Packet8d_(NAME, X) \
  const Packet8d p8d_##NAME = pset1<Packet8d>(X)

#define EIGEN_DECLARE_CONST_Packet8d_FROM_INT64_(NAME, X) \
  const Packet8d p8d_##NAME = _mm512_castsi512_pd(_mm512_set1_epi64(X))

#define EIGEN_DECLARE_CONST_Packet16bf_(NAME, X) \
  const Packet16bf p16bf_##NAME = pset1<Packet16bf>(X)

#define EIGEN_DECLARE_CONST_Packet16bf_FROM_INT_(NAME, X) \
...
pexp<Packet16f>(const Packet16f& _x) {
  EIGEN_DECLARE_CONST_Packet16f_(1, 1.0f);
  EIGEN_DECLARE_CONST_Packet16f_(half, 0.5f);
  EIGEN_DECLARE_CONST_Packet16f_(127, 127.0f);

  EIGEN_DECLARE_CONST_Packet16f_(exp_hi, 88.3762626647950f);
  EIGEN_DECLARE_CONST_Packet16f_(exp_lo, -88.3762626647949f);

  EIGEN_DECLARE_CONST_Packet16f_(cephes_LOG2EF, 1.44269504088896341f);

  EIGEN_DECLARE_CONST_Packet16f_(cephes_exp_p0, 1.9875691500E-4f);
  EIGEN_DECLARE_CONST_Packet16f_(cephes_exp_p1, 1.3981999507E-3f);
  EIGEN_DECLARE_CONST_Packet16f_(cephes_exp_p2, 8.3334519073E-3f);
  EIGEN_DECLARE_CONST_Packet16f_(cephes_exp_p3, 4.1665795894E-2f);
  EIGEN_DECLARE_CONST_Packet16f_(cephes_exp_p4, 1.6666665459E-1f);
  EIGEN_DECLARE_CONST_Packet16f_(cephes_exp_p5, 5.0000001201E-1f);
  ...
  EIGEN_DECLARE_CONST_Packet16f_(nln2, -0.6931471805599453f);
...
prsqrt<Packet16f>(const Packet16f& _x) {
  EIGEN_DECLARE_CONST_Packet16f_FROM_INT_(inf, 0x7f800000);
  EIGEN_DECLARE_CONST_Packet16f_(one_point_five, 1.5f);
  EIGEN_DECLARE_CONST_Packet16f_(minus_half, -0.5f);
...
template <>
EIGEN_STRONG_INLINE Packet16f prsqrt<Packet16f>(const Packet16f& x) {
  EIGEN_DECLARE_CONST_Packet16f_(one, 1.0f);
...
prsqrt<Packet8d>(const Packet8d& _x) {
  EIGEN_DECLARE_CONST_Packet8d_(one_point_five, 1.5);
  EIGEN_DECLARE_CONST_Packet8d_(minus_half, -0.5);
  EIGEN_DECLARE_CONST_Packet8d_FROM_INT64_(inf, 0x7ff0000000000000LL);
...
EIGEN_STRONG_INLINE Packet8d prsqrt<Packet8d>(const Packet8d& x) {
  EIGEN_DECLARE_CONST_Packet8d_(one, 1.0f);
