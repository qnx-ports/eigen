...
// on device. Half-packet host function are needed in a HIP/tensorflow environment, however,
// so that the half type matches between gcc/hipcc compilers.
#if ((defined(EIGEN_HAS_CUDA_FP16) && defined(EIGEN_GPU_COMPILE_PHASE)) || defined(EIGEN_HAS_HIP_FP16))
...
#endif // ((defined(EIGEN_HAS_CUDA_FP16) && defined(EIGEN_GPU_COMPILE_PHASE)) || defined(EIGEN_HAS_HIP_FP16))
