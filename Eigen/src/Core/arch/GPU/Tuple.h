...
class TupleImpl<N, T1, Ts...> {
 public:
  ...
  template <typename U1 = T1, typename EnableIf = typename std::enable_if<
                                  ...
                                  reduce_all<std::is_default_constructible<Ts>::value...>::value>::type>
  ...
  template <typename U1, typename... Us,
            ...
            typename EnableIf = typename std::enable_if<
                ...
                sizeof...(Us) == sizeof...(Ts) && (
                                                      ...
                                                      N > 1 || std::is_convertible<U1, T1>::value)>::type>
...
struct tuple_cat_impl<NTuples, TupleImpl<N1, Args1...>, TupleImpl<N2, Args2...>, Tuples...> {
  ...
  static EIGEN_CONSTEXPR EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE ReturnType run(Tuple1&& tuple1, index_sequence<I1s...>,
  ...
  static EIGEN_CONSTEXPR EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE ReturnType run(Tuple1&& tuple1, Tuple2&& tuple2,
                                                                              MoreTuples&&... tuples) {
    return run(std::forward<Tuple1>(tuple1), make_index_sequence<N1>{}, std::forward<Tuple2>(tuple2),
               make_index_sequence<N2>{}, std::forward<MoreTuples>(tuples)...);
  }
};
 ...
 */
template <typename... Tuples, typename EnableIf = typename std::enable_if<internal::reduce_all<
...
EIGEN_CONSTEXPR EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE tuple<Args...> forward_as_tuple(Args&&... args) {
