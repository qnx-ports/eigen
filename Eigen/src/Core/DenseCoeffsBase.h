...
{
  typedef conditional_t<is_arithmetic<T>::value, T, typename add_const_on_value_type<T>::type> type;
};
}
...
class DenseCoeffsBase<Derived,ReadOnlyAccessors> : public EigenBase<Derived>
{
  public:
    ...
    typedef internal::conditional_t<bool(internal::traits<Derived>::Flags&LvalueBit),
                const Scalar&,
                internal::conditional_t<internal::is_arithmetic<Scalar>::value, Scalar, const Scalar>
            > CoeffReturnType;
