  ...
  static EIGEN_STRONG_INLINE void run(Index size, Index depth, const LhsScalar* _lhs, Index lhsStride,
    ...
    for (Index k2 = 0; k2 < depth; k2 += kc) {
      ...
      for (Index i2 = 0; i2 < size; i2 += mc) {
        ...
        sybb(_res + resStride * i2 + resIncr * i2, resIncr, resStride, blockA, blockB + actual_kc * i2, actual_mc,
             actual_kc, alpha);
...
struct tribb_kernel {
  ...
  void operator()(ResScalar* _res, Index resIncr, Index resStride, const LhsScalar* blockA, const RhsScalar* blockB,
