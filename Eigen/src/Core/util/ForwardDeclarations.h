...
template <typename PlainObjectType, int Options = 0,
          typename StrideType = typename internal::conditional<PlainObjectType::IsVectorAtCompileTime, InnerStride<1>,
                                                               OuterStride<> >::type>
class Ref;
...
class Transform;
template <typename Scalar_, int _AmbientDim, int Options = AutoAlign>
