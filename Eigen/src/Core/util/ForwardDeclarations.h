...
template<typename MatrixType, typename Options=internal::DecompositionOptionsTag<0>> class JacobiSVD;
template<typename MatrixType, typename Options=internal::DecompositionOptionsTag<0>> class BDCSVD;
