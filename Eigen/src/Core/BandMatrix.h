...
class BandMatrixBase : public EigenBase<Derived> {
 ...
 public:
  ...
  struct DiagonalIntReturnType {
    ...
    typedef typename internal::conditional<Conjugate, CwiseUnaryOp<internal::scalar_conjugate_op<Scalar>, BuildType>,
                                           BuildType>::type Type;
  };
...
template <typename _CoefficientsType, int Rows_, int Cols_, int Supers_, int Subs_, int Options_>
class BandMatrixWrapper
    : public BandMatrixBase<BandMatrixWrapper<_CoefficientsType, Rows_, Cols_, Supers_, Subs_, Options_> > {
 public:
