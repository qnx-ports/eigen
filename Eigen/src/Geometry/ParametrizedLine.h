...
class ParametrizedLine {
 public:
  ...
  enum { AmbientDimAtCompileTime = _AmbientDim, Options = Options_ };
  ...
  intersectionParameter(const Hyperplane<Scalar_, _AmbientDim, OtherOptions>& hyperplane) const;
  ...
  intersectionPoint(const Hyperplane<Scalar_, _AmbientDim, OtherOptions>& hyperplane) const;
...
template <typename Scalar_, int _AmbientDim, int Options_>
template <int OtherOptions>
EIGEN_DEVICE_FUNC inline ParametrizedLine<Scalar_, _AmbientDim, Options_>::ParametrizedLine(
    const Hyperplane<Scalar_, _AmbientDim, OtherOptions>& hyperplane) {
...
template <typename Scalar_, int _AmbientDim, int Options_>
template <int OtherOptions>
EIGEN_DEVICE_FUNC inline Scalar_ ParametrizedLine<Scalar_, _AmbientDim, Options_>::intersectionParameter(
    const Hyperplane<Scalar_, _AmbientDim, OtherOptions>& hyperplane) const {
...
template <typename Scalar_, int _AmbientDim, int Options_>
template <int OtherOptions>
EIGEN_DEVICE_FUNC inline Scalar_ ParametrizedLine<Scalar_, _AmbientDim, Options_>::intersection(
    const Hyperplane<Scalar_, _AmbientDim, OtherOptions>& hyperplane) const {
...
template <int OtherOptions>
EIGEN_DEVICE_FUNC inline typename ParametrizedLine<Scalar_, _AmbientDim, Options_>::VectorType
ParametrizedLine<Scalar_, _AmbientDim, Options_>::intersectionPoint(
    const Hyperplane<Scalar_, _AmbientDim, OtherOptions>& hyperplane) const {
