...
void testNSGA2_Binh_and_Korn() {
  ...
  using solver_t = NSGA2<std::array<double, 2>, 2, FITNESS_LESS_BETTER, RecordOption::DONT_RECORD_FITNESS, args_t,
                         Eigen::GADefaults<std::array<double, 2>, args_t, Std>::iFunNd, nullptr,
