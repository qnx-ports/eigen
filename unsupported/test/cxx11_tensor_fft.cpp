...
static void test_fft_real_input_energy() {
  ...
  typedef internal::conditional_t<isComplexInput == true, std::complex<RealScalar>, RealScalar> InputScalar;
  ...
  typedef internal::conditional_t<FFTResultType == Eigen::BothParts, std::complex<RealScalar>, RealScalar> OutputScalar;
