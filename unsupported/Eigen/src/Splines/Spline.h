...
class Spline {
 ...
 private:
  ...
  static void BasisFunctionDerivativesImpl(const typename Spline<Scalar_, Dim_, _Degree>::Scalar u,
...
DenseIndex Spline<Scalar_, Dim_, _Degree>::Span(
    typename SplineTraits<Spline<Scalar_, Dim_, _Degree> >::Scalar u, DenseIndex degree,
...
template <typename Scalar_, int Dim_, int _Degree>
typename Spline<Scalar_, Dim_, _Degree>::BasisVectorType Spline<Scalar_, Dim_, _Degree>::BasisFunctions(
    typename Spline<Scalar_, Dim_, _Degree>::Scalar u, DenseIndex degree,
...
template <typename Scalar_, int Dim_, int _Degree>
typename SplineTraits<Spline<Scalar_, Dim_, _Degree> >::DerivativeType Spline<Scalar_, Dim_, _Degree>::derivatives(
...
template <typename Scalar_, int Dim_, int _Degree>
typename SplineTraits<Spline<Scalar_, Dim_, _Degree> >::BasisVectorType Spline<Scalar_, Dim_, _Degree>::basisFunctions(
    Scalar u) const {
...
void Spline<Scalar_, Dim_, _Degree>::BasisFunctionDerivativesImpl(
    const typename Spline<Scalar_, Dim_, _Degree>::Scalar u, const DenseIndex order, const DenseIndex p,
    const typename Spline<Scalar_, Dim_, _Degree>::KnotVectorType& U, DerivativeType& N_) {
...
Spline<Scalar_, Dim_, _Degree>::BasisFunctionDerivatives(
    const typename Spline<Scalar_, Dim_, _Degree>::Scalar u, const DenseIndex order, const DenseIndex degree,
    const typename Spline<Scalar_, Dim_, _Degree>::KnotVectorType& knots) {
