...
template <typename Scalar_, int _Deg>
inline bool companion<Scalar_, _Deg>::balanced(RealScalar colNorm, RealScalar rowNorm, bool& isBalanced,
...
template <typename Scalar_, int _Deg>
inline bool companion<Scalar_, _Deg>::balancedR(RealScalar colNorm, RealScalar rowNorm, bool& isBalanced,
                                                RealScalar& colB, RealScalar& rowB) {
