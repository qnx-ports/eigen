...
public:
  typedef ei::Matrix<typename ArgType::Scalar,
                 ...
                 ArgType::Flags&ei::RowMajorBit?ei::RowMajor:ei::ColMajor,
...
// [function]
template <class ArgType, class RowIndexType, class ColIndexType>
ei::CwiseNullaryOp<indexing_functor<ArgType,RowIndexType,ColIndexType>, typename indexing_functor<ArgType,RowIndexType,ColIndexType>::MatrixType>
...
int main()
{
  ...
  ei::Array3i ri(1,2,1);
  ei::ArrayXi ci(6); ci << 3,2,1,0,0,2;
  ...
  B =  mat_indexing(A, ei::ArrayXi::LinSpaced(13,0,12).unaryExpr([](int x){return x%4;}), ei::ArrayXi::LinSpaced(4,0,3));
